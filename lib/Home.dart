  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: Drawer(
        ...
        child: ListView(
          children: <Widget>[
            Container(alignment: Alignment.topLeft,child: IconButton(onPressed: (){
                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            title: Text(
                              "DID YOU REALLY WANT TO END THIS?",
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await mysql.insert("costs", {
                                      "day":
                                          convert_preview(data["data"][0].frm),
                                      "tasks": temperary,
                                      "play": cost,
                                    });
                                    await mysql.deletedb(
                                        "DELETE FROM orders WHERE 'key' > 0");
                                    Navigator.pushNamedAndRemoveUntil(
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          STATE=data["data"][index].special=="true"?true:false;
                          return Card(
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    onLongPress: () {
                                      Navigator.pushNamed(context, "update",
                                          arguments: {
                                            ...
                                            "Hours": setdifference_in_Hours(
                                                data["data"][index].frm,
                                                data["data"][index].too),
                                            "Minutes": setdifference_in_Minutes(
                                                data["data"][index].frm,
                                                data["data"][index].too),
                                          });
                                    },
                                    ...
                                    subtitle: Row(
                                      children: [
                                        ...
                                        Expanded(
                                            flex: 2,
                                            child: checkcolor(data["data"][index]
                                                            .too) ==
                                                        true ||
                                                    data["data"][index].too ==
                                                        "Still Running"
                                                        ...
                                                        actions: [
                                                          ElevatedButton(
                                                              ...
                                                              onPressed:
                                                                ...
                                                                sql mysql = sql();
                                                                await mysql.deletedb(
                                                                    "DELETE FROM tables WHERE id = ${data["data"][index].id}");
                                                                Navigator
                                  ...
                                  Container(
                                    ...
                                    Colors.green[200] ,
                                    child: CheckboxListTile(value: STATE,
                                        title: Text("ORDERS"),
                                        onChanged: (value)async{
                                          ...
                                          setState(() {
                                        STATE=value!;
                                        data["data"][index].special=value.toString();
                                      });
...
int cost_calculator(play_lists data) {
  try {
    bool mass = false;
    int cost_demo = 0;
    ...
    if (data.kind == "Multi") {
      ...
      if (data.place == "Ps6")
        cost_demo = cost_demo % 5 < 3.2
            ? cost_demo - (cost_demo % 5)
            : cost_demo + (5 - (cost_demo % 5));
      else
        cost_demo = cost_demo % 5 < 3.2
            ? cost_demo - (cost_demo % 5)
            : cost_demo + (5 - (cost_demo % 5));
