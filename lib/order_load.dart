...
int cost=0;
class Load_order extends StatefulWidget {
  const Load_order({super.key});

  @override
  State<Load_order> createState() => _Load_orderState();
}

class _Load_orderState extends State<Load_order> {
  Future getdata()async{

    List<Map> instance2=[];
    sql SQL=sql();
    instance2=await SQL.readdb('SELECT * FROM disorders');
    ...
    Navigator.pushNamedAndRemoveUntil(context, "orders", (route) => false,arguments: {
      "data2":listed2,
    }
    );
